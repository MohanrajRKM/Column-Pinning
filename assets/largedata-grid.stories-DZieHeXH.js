import{j as t}from"./index-CTAXdLKx.js";import{r as d}from"./index-D5jfS-9e.js";import{C as U,a as H,S as y,P as He,b as Ge,Q as Te,i as jn,c as Be,d as Ke,e as Wn,G as Un,u as V,f as Hn,g as Bn,h as Kn,j as Qn,k as Y,W as $n,A as ge,l as z,m as Ve,O as _n,T as Qe,U as Jn,n as Xn}from"./Aggregate-xL2LTbhA.js";import"./client-Spw3EFno.js";import{m as Yn,a as Zn,u as I,b as P,c as O,d as N,e as L,f as M,g as D,h as E,i as A,j as R,k as T,l as G,n as F,o as et,p as nt,q as tt}from"./data-D5YP53at.js";import{u as ot}from"./useGridTheme--cTLNcRo.js";const at=[40,80,120,200],ze=r=>{var Oe,Ne,Le,je,We,Ue;const{enableRtl:v,enableRipple:c,localDataCount:s,isTextWrapData:g,isDialogInsideGrid:h,isStrictMode:k,isMultipleChildren:B,enableDarkMode:j=!1,builtInThemes:he="material",parentContainerHeight:Rn="87vh",isCustomBinding:Z,serverPageSize:fe,defaultOpenGroupExpandKeys:K,isConditionalRowSelection:Ie,...e}=r;((Le=(Ne=e.columns)==null?void 0:Ne[((Oe=e.columns)==null?void 0:Oe.length)-1])==null?void 0:Le.headerText)==="Command Actions"&&(e.columns[((je=e.columns)==null?void 0:je.length)-1].getCommandItems=()=>[t.jsx(U,{type:H.Edit},"Edit"),t.jsx(U,{type:H.Delete},"Delete"),t.jsx(U,{type:H.Update},"Update"),t.jsx(U,{type:H.Cancel},"Cancel")]);const C=d.useRef(null),Fe=d.useRef(null),[ke,Tn]=d.useState(!0),[Q,Gn]=d.useState(!1);ot(he,e.enableDevMode);const S=d.useMemo(()=>g?Yn(s):Zn(s,e.columns),[s,(We=e.columns)==null?void 0:We.length]),[Fn,kn]=d.useState({result:[],count:0,hasMore:((Ue=r.virtualizationSettings)==null?void 0:Ue.scrollMode)===y.Infinite}),qe=d.useCallback(n=>{if(!n.isComplex)return new He(n.field,n.operator,n.value,n.ignoreCase,n.ignoreAccent,n.matchCase);let o=null;const a=n.predicates||[],p=n.condition||"and";for(let m=0;m<a.length;m++){const u=qe(n.predicates[m]);o===null?o=u:o=p.toLowerCase()==="or"?o.or(u):o.and(u)}return o||new He("","","")},[]),Pe=d.useCallback(n=>{var p,m,u,f,q,b,$,ee,ne,te,oe,ae,re,le,ie,_,se,J,de,X,ue,ce,pe;const o=new Ge(S),a=new Te;if((p=n.where)!=null&&p.length){const l=n.where[0],i=qe(l);a.where(i)}if((m=n.search)!=null&&m.length){const{fields:l,value:i}=n.search[0];a.search(i,l)}if((u=n.sort)!=null&&u.length||(f=n.groups)!=null&&f.length&&n.isInitialLoad)if(n.isInitialLoad&&((q=n.groups)!=null&&q.length)){const l=[];for(let i=n.sort.length-1;i>-1;i--)(l==null?void 0:l.find(w=>w.field===n.sort[i].field))||((b=n.groups)!=null&&b.length&&(($=n.groups)!=null&&$.includes(n.sort[i].field))?l.push({field:n.sort[i].field,direction:n.sort[i].direction}):a.sortBy(n.sort[i].field,n.sort[i].direction));l.length&&l.forEach(i=>{a.sortBy(i.field,i.direction)})}else n.sort.forEach(l=>{a.sortBy(l.field,l.direction)});if((ee=n.aggregates)!=null&&ee.length||(te=(ne=C.current)==null?void 0:ne.aggregates)!=null&&te.length){const l=(oe=n.aggregates)!=null&&oe.length?n.aggregates:(ae=C.current)==null?void 0:ae.aggregates;for(let i=0;i<(l==null?void 0:l.length);i++)if((re=l[i])!=null&&re.columns)for(let x=0;x<((le=l[i])==null?void 0:le.columns.length);x++){const w=l[i].columns[x];if(Array.isArray(w.type))for(let me=0;me<w.type.length;me++)a.aggregate((se=(_=(ie=w.type)==null?void 0:ie[me])==null?void 0:_.toLowerCase)==null?void 0:se.call(_),w.field);else a.aggregate((de=(J=w.type)==null?void 0:J.toLowerCase)==null?void 0:de.call(J),w.field)}else{const x=l[i];a.aggregate((ue=(X=x.type)==null?void 0:X.toLowerCase)==null?void 0:ue.call(X),x.field)}}if(n.groups&&((ce=n.groups)!=null&&ce.length))for(let l=0;l<n.groups.length;l++){const i=n.groups[parseInt(l.toString(),10)];a.group(i)}if(n.take&&n.skip){const l=n.skip/n.take+1,i=n.take;a.page(l,i)}else if(n.skip===0&&n.take)a.page(1,n.take);else if(!jn(n.skip)&&!n.take&&((pe=r.virtualizationSettings)==null?void 0:pe.scrollMode)===y.Infinite){const l=n.skip/fe+1;a.page(l,fe)}n.requiresCounts&&a.requiresCount(),console.log("onDataRequest => ",n,a),o.executeQuery(a).then(l=>{if(n.requestType==="filterChoiceRequest"){const i={result:Be.distinct(l.result,n.select[0],!0),count:l.count};if(n.distinctCounts){const x=new Te;if(n.distinct){const w=n.distinct[0],me=qe(w);x.where(me)}n.select&&x.select(n.select),console.log("onDataRequest => ",n,a),o.executeQuery(x).then(w=>{i.distinctCount=Be.distinct(w.result,n.select[0],!0).length,n.dataSource(i)})}else n.dataSource(i)}else kn({...l,hasMore:S.length>(n.skip??0)+l.result.length})})},[]),qn=d.useCallback(n=>{setTimeout(()=>{if(console.log("onDataChangeRequest => ",n),Array.isArray(n.data)){n.data.forEach(o=>{const a=S.findIndex(p=>p.id===o.id);a!==-1&&(S[a]={...S[a],...o})}),n.saveDataChanges();return}if(n.action==="Add"&&S.unshift(n.data),n.action==="Edit"){for(let o=0;o<S.length;o++)if(S[o].id===n.data.id){S[o]=n.data;break}}if(n.action==="Delete"){for(let o=0;o<n.data.length;o++)for(let a=0;a<S.length;a++)if(S[a].id===n.data[o].id){S.splice(a,1);break}}n.saveDataChanges()},0)},[]),zn=d.useMemo(()=>{var p,m;if(!Z)return;const n=((p=e==null?void 0:e.aggregates)==null?void 0:p.reduce((u,f)=>{var q;return(q=f.columns)==null||q.forEach(b=>{Array.isArray(b.type)?b.type.forEach($=>{u.push({type:$.toLowerCase(),field:b.field})}):u.push({type:b.type.toLowerCase(),field:b.field})}),u},[]))??[],o=((m=e==null?void 0:e.columns)==null?void 0:m.reduce((u,f)=>(f.groupCaptionAggregateType&&u.push(...Array.isArray(f.groupCaptionAggregateType)?f.groupCaptionAggregateType.map(q=>({type:q.toLowerCase(),field:f.field})):[{type:f.groupCaptionAggregateType.toLowerCase(),field:f.field}]),u),[]))??[],a=n==null?void 0:n.concat(o);return a!=null&&a.length?a:void 0},[Z,e==null?void 0:e.aggregates,e==null?void 0:e.columns,Q]);d.useEffect(()=>{var n,o,a,p,m,u,f,q,b,$,ee,ne,te,oe,ae,re,le,ie,_,se,J,de;Z&&Q&&Pe({skip:((n=e==null?void 0:e.pageSettings)==null?void 0:n.currentPage)*((o=e==null?void 0:e.pageSettings)==null?void 0:o.pageSize)||0,...((a=e.virtualizationSettings)==null?void 0:a.scrollMode)!==y.Infinite||(p=e.pageSettings)!=null&&p.estimatedTotalRecordsCount||((m=e.pageSettings)==null?void 0:m.pageSizeControlledBy)==="client"?{take:fe??((u=e==null?void 0:e.pageSettings)==null?void 0:u.pageSize)??(((f=e.virtualizationSettings)==null?void 0:f.scrollMode)===y.Auto||!((q=e.virtualizationSettings)!=null&&q.scrollMode)?12:50)}:{take:fe},groups:(b=e==null?void 0:e.groupSettings)!=null&&b.enabled?($=e==null?void 0:e.groupSettings)==null?void 0:$.columns:[],where:[],search:[],sort:(ee=e==null?void 0:e.sortSettings)!=null&&ee.enabled&&((te=(ne=e==null?void 0:e.sortSettings)==null?void 0:ne.columns)!=null&&te.length)&&(!((oe=e==null?void 0:e.groupSettings)!=null&&oe.enabled)||!((ae=e==null?void 0:e.groupSettings)!=null&&ae.columns))?(re=e==null?void 0:e.sortSettings)==null?void 0:re.columns:(((le=e==null?void 0:e.sortSettings)==null?void 0:le.columns)??[]).concat((ie=e==null?void 0:e.groupSettings)!=null&&ie.enabled&&((_=e==null?void 0:e.groupSettings)!=null&&_.columns)?(J=(se=e==null?void 0:e.groupSettings)==null?void 0:se.columns)==null?void 0:J.map(X=>{var ue,ce,pe;return{field:X,direction:((pe=(ce=(ue=e==null?void 0:e.sortSettings)==null?void 0:ue.columns)==null?void 0:ce.find(l=>l.field===X))==null?void 0:pe.direction)??"Ascending"}}):[]),aggregates:zn??[],...((de=e.virtualizationSettings)==null?void 0:de.scrollMode)!==y.Infinite?{requiresCounts:!0}:{},isInitialLoad:!0})},[Q]),d.useEffect(()=>{j?document.body.classList.add("dark","sf-dark-mode"):document.body.classList.remove("dark","sf-dark-mode")},[j]);const Vn=d.useCallback(n=>n.id%2===0||n.EmployeeID%2===0||n.RecordId%2===0?{selectable:!1}:!0,[Ie]),In=d.useCallback(n=>{var o;return(o=K.includes)==null?void 0:o.call(K,n==null?void 0:n.groupKey)},[K]),Pn=d.useCallback(n=>{console.error("Grid Error: ",n)},[e==null?void 0:e.onError]),On=d.useCallback(n=>at[n.rowIndex%4],[e==null?void 0:e.getRowHeight]),Nn=d.useMemo(()=>e.children?void 0:e.columns,[e==null?void 0:e.columns,e==null?void 0:e.children]),Ln=d.useMemo(()=>e.children?void 0:e.aggregates,[e==null?void 0:e.aggregates,e==null?void 0:e.children]),Ce=()=>{var n;return t.jsxs(t.Fragment,{children:[t.jsxs("button",{onClick:()=>{var o,a;Q&&window.localStorage.removeItem((a=(o=C==null?void 0:C.current)==null?void 0:o.getDataModule())==null?void 0:a.dataManager.guidId),Gn(!Q)},children:[Q?"Destroy":"Render"," Data Grid"]}),s&&!g&&t.jsxs("button",{onClick:()=>Tn(!ke),children:[ke?"Uniform":"Non Uniform"," Row Height Applied"]}),(n=e==null?void 0:e.groupSettings)!=null&&n.enabled?t.jsxs(t.Fragment,{children:[t.jsx("button",{onClick:()=>{var o,a,p;(p=(o=C.current)==null?void 0:o.groupColumn)==null||p.call(o,(a=e==null?void 0:e.groupSettings)==null?void 0:a.columns,!0)},children:"Reset Grouped Columns to Default"}),t.jsx("button",{onClick:()=>{var o,a,p,m,u;(u=(o=C.current)==null?void 0:o.ungroupColumn)==null||u.call(o,[(m=(p=(a=C.current)==null?void 0:a.groupSettings)==null?void 0:p.columns)==null?void 0:m[0]])},children:"Un Group First Grouped Column"}),t.jsx("button",{onClick:()=>{var o,a;(a=(o=C.current)==null?void 0:o.expandAll)==null||a.call(o)},children:"Expand All"}),t.jsx("button",{onClick:()=>{var o,a;(a=(o=C.current)==null?void 0:o.collapseAll)==null||a.call(o)},children:"Collapse All"}),t.jsx("button",{onClick:()=>{var o,a;(a=(o=C.current)==null?void 0:o.clearGrouping)==null||a.call(o)},children:"Clear Grouping"})]}):null,t.jsx("br",{}),t.jsx("br",{}),Q&&t.jsx(Wn,{dir:v?"rtl":"ltr",ripple:c,locale:e.locale,children:t.jsx(Un,{ref:C,dataSource:Z?Fn:s?S:[],onDataRequest:Z?Pe:void 0,onDataChangeRequest:Z?qn:void 0,shouldExpandGroup:K!=null&&K.length?In:void 0,onError:Pn,...e,isRowSelectable:Ie?Vn:void 0,columns:Nn,aggregates:Ln,getRowHeight:ke?null:On,children:B?d.useMemo(()=>e.children.props.children,[e==null?void 0:e.children]):e.children})}),t.jsx("br",{}),t.jsx("button",{onClick:()=>{console.log(C)},children:"dummy navigation checking button with get GridRef"})]})};return t.jsx("div",{ref:Fe,style:{height:Rn,isolation:"isolate"},className:j?"dark sf-dark-mode":"",children:k?t.jsx(d.StrictMode,{children:h?t.jsx(Ke,{open:!0,fullScreen:!0,target:Fe.current,children:Ce()}):Ce()}):h?t.jsx(Ke,{open:!0,fullScreen:!0,target:Fe.current,children:Ce()}):Ce()})};try{ze.displayName="LargeDataGridTest",ze.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
/>
\`\`\``,name:"columnChooserSettings",required:!1,type:{name:"ColumnChooserSettings"}},columnMenuSettings:{defaultValue:null,description:"Settings for the inline column menu displayed inside header cells.\nWhen `enabled` is true, a small per-column menu trigger will render in the header cell.",name:"columnMenuSettings",required:!1,type:{name:"ColumnMenuSettings"}},onColumnMenuOpen:{defaultValue:null,description:`Fires when the column menu is opened for a specific header column.
Provides the menu items and the target column for customization or cancellation.
@event onColumnMenuOpen
@param event - Event payload containing the column and available actions.
@returns The updated event or a Promise resolving to it.`,name:"onColumnMenuOpen",required:!1,type:{name:"(event: ColumnMenuOpenEvent) => void | ColumnMenuOpenEvent | Promise<ColumnMenuOpenEvent>"}},onColumnMenuClose:{defaultValue:null,description:`Fires when the column menu is closed.
Useful for resetting UI state after the menu finishes interacting.
@event onColumnMenuClose
@param event - Event payload containing the closed column.
@returns`,name:"onColumnMenuClose",required:!1,type:{name:"(event: ColumnMenuCloseEvent) => void"}},onColumnMenuClick:{defaultValue:null,description:`Fires when a column menu item is selected.
Provides the item identifier and the target column for custom logic.
@event onColumnMenuClick
@param event - Event payload containing the clicked item and column.
@returns`,name:"onColumnMenuClick",required:!1,type:{name:"(event: ColumnMenuClickEvent) => void"}},rowClass:{defaultValue:{value:"-"},description:`Applies a CSS class to each grid row either globally or conditionally.
...
\`\`\``,name:"onColumnResizeEnd",required:!1,type:{name:"(event: ColumnResizeEndEvent) => void"}},onColumnReorderStart:{defaultValue:null,description:`Fires when a column reorder interaction begins.
@event onColumnReorderStart
@param event - Event arguments containing the targeted column, \`fromIndex\`, initial \`toIndex\`, and a cancelable flag.
@returns
@example \`\`\`tsx
...
\`\`\``,name:"onColumnReorderStart",required:!1,type:{name:"(event: ColumnReorderStartEvent<unknown>) => void"}},onColumnDrag:{defaultValue:null,description:"Fires while a column reorder drag is in progress.\n@event onColumnDrag\n@param event - Event arguments containing the targeted column, `fromIndex`, and current `toIndex`.\n@returns\n@example ```tsx\nconst handleColumnDrag = (event: ColumnReorderEvent) => {\n  console.log('Dragging', event.column.field, 'from', event.fromIndex, 'to', event.toIndex);\n};\n\nreturn <Grid onColumnDrag={handleColumnDrag} />;\n```",name:"onColumnDrag",required:!1,type:{name:"(event: ColumnReorderEvent<unknown>) => void"}},onColumnReorderEnd:{defaultValue:null,description:"Fires when a column reorder interaction ends.\n@event onColumnReorderEnd\n@param event - Event arguments containing the targeted column, `fromIndex`, final `toIndex`, and a cancelable flag.\n@returns\n@example ```tsx\nconst handleReorderEnd = (event: ColumnReorderEndEvent) => {\n  console.log('Reordered', event.column.field, 'from', event.fromIndex, 'to', event.toIndex);\n};\n\nreturn <Grid onColumnReorderEnd={handleReorderEnd} />;\n```",name:"onColumnReorderEnd",required:!1,type:{name:"(event: ColumnReorderEndEvent<unknown>) => void"}},onRowDoubleClick:{defaultValue:null,description:`Fires when a grid row is clicked.
...
/>
\`\`\``,name:"isRowPinnable",required:!1,type:{name:"(row: unknown) => boolean"}},pinningSettings:{defaultValue:{value:"undefined"},description:`Global configuration settings for pinning behavior across both rows and columns.
...
<Grid
  dataSource={employees}
  pinningSettings={{ enabled: true, type: PinScope.Both, allowLeftPin: true, allowRightPin: true }}
  isRowPinned={(row) => row.isPinned ? 'top' : null}
/>
\`\`\``,name:"pinningSettings",required:!1,type:{name:"PinningSettings"}},onPinnedRowsChanged:{defaultValue:null,description:`Fires when a row changes its pinning state due to user interaction or programmatic update.
...
\`\`\``,name:"onPinnedRowsChanged",required:!1,type:{name:"(event: RowPinningEvent<unknown>) => void"}}}}}catch{}const mt={title:"Grid/VirtualGridBase",component:ze,parameters:{layout:"fullscreen",docs:{description:{component:"A fully configurable Grid component with performance comparison capabilities."}}},argTypes:{localDataCount:{control:"select",options:["0","100","1000","10000","100000"],description:"Grid Local DataSource Count"},builtInThemes:{control:"select",options:["bootstrap","tailwind","material"],description:"Grid Built-in Themes"}}},W=tt(100,!1),rt=[{columns:nt(W.length)}];W.unshift({type:Y.Checkbox,width:50,allowFilter:!1});W.push({headerText:"Command Actions",width:200,getCommandItems:()=>[t.jsx(U,{type:H.Edit},"Edit"),t.jsx(U,{type:H.Delete},"Delete"),t.jsx(U,{type:H.Update},"Update"),t.jsx(U,{type:H.Cancel},"Cancel")]});const Se={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:T,PagerModule:R,GroupModule:A,ToolbarModule:E,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:L,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},localDataCount:1e5,columns:(()=>{let r=[...W];return r.unshift({type:Y.SingleGroup}),r=r.map(v=>({...v,...v.field==="sales"?{groupCaptionAggregateType:ge.Min}:{}})),r})(),aggregates:rt,groupSettings:{enabled:!1,columns:["category","product","region"],showDropArea:!0,type:Qn.SingleColumn,defaultExpanded:!0},onGroupStart:()=>{console.log("onGroupStart Started")},onGroup:r=>{console.log("Group action: ",r)},onSortStart:()=>{console.log("Sort Started")},onSort:r=>{console.log("Sort action: ",r)},defaultOpenGroupExpandKeys:["Camera","Camera-South America","Gaming Chair","Gaming Chair-South Asia","Tires","Tires-East Asia","Air Conditioner","Air Conditioner-North Africa","Game Controller","Game Controller-South Asia","Mouse","Mouse-South America","Accessories","Accessories-Camera","Accessories-Camera-South America","Construction","Construction-Gaming Chair","Construction-Gaming Chair-South Asia","Energy","Energy-Tires","Energy-Tires-East Asia","Healthcare","Healthcare-Air Conditioner","Healthcare-Air Conditioner-North Africa","Logistics","Logistics-Game Controller","Logistics-Game Controller-South Asia","Peripherals","Peripherals-Mouse","Peripherals-Mouse-South America"],virtualizationSettings:{scrollMode:y.Virtual,enableCache:!1},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel",enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:1e5},height:"100%",onRowSelect:r=>{console.log("Row Selected: ",r)}}},we={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:T,PagerModule:R,GroupModule:A,ToolbarModule:E,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:L,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},localDataCount:2e6,isConditionalRowSelection:!0,columns:W.slice(0,11),editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},pageSettings:{enabled:!0,pageSize:2e6},height:"100%"}},ye={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:T,PagerModule:R,GroupModule:A,ToolbarModule:E,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:L,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},dataSource:new Ge({url:"https://ej2services.syncfusion.com/js/development/api/UrlDataSource",adaptor:new Jn}),query:new Te().addParams("dataCount","100000"),toolbar:["Search"],isConditionalRowSelection:!0,groupSettings:{enabled:!1,showDropArea:!0,type:"GroupRows",defaultExpanded:!0,columns:["Designation","Employees"]},onGroup:r=>{console.log("Group action: ",r)},defaultOpenGroupExpandKeys:["CFO","CFO-Kathryn Fuller","Designer","Designer-Kathryn Fuller","Developer","Developer-Kathryn Fuller","Project Lead","Project Lead-Kathryn Fuller","System Analyst","System Analyst-Kathryn Fuller"],columns:[{type:Y.Checkbox,width:50,allowFilter:!1},{field:"EmployeeID",visible:!0,headerText:"Employee ID",isPrimaryKey:!0,width:"150"},{field:"Employees",headerText:"Employee Name",width:"230",clipMode:"EllipsisWithTooltip"},{field:"Designation",headerText:"Designation",width:"170",clipMode:"EllipsisWithTooltip"},{field:"Mail",headerText:"Mail",width:"230"},{field:"Location",headerText:"Location",width:"140"},{field:"Status",headerText:"Status",width:"130"},{field:"Trustworthiness",headerText:"Trustworthiness",width:"160"},{field:"Rating",headerText:"Rating",width:"220"},{field:"Software",headerText:"Software Proficiency",width:"180",format:"C2"},{field:"CurrentSalary",headerText:"Current Salary",width:"200",format:"C2"},{field:"Address",headerText:"Address",width:"240",clipMode:"EllipsisWithTooltip"}],searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel"},pageSettings:{pageSize:50},virtualizationSettings:{enableCache:!1,scrollMode:y.Virtual},height:"100%"}},ve={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:T,PagerModule:R,GroupModule:A,ToolbarModule:E,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:L,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},dataSource:new Ge({url:"https://ej2services.syncfusion.com/react/development/api/GridWebAPIService",adaptor:new Xn}),columns:[{type:Y.Checkbox,width:50,allowFilter:!1},{field:"OrderID",headerText:"OrderID",isPrimaryKey:!0,width:"130",allowSearch:!1},{field:"CustomerID",headerText:"CustomerID",width:"230",clipMode:"EllipsisWithTooltip"},{field:"ShipCity",headerText:"ShipCity",width:"230"},{field:"EmployeeID",headerText:"EmployeeID",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1},{field:"EmployeeName",headerText:"EmployeeName",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"Designation",headerText:"Designation",width:"230",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1},{field:"CurrentSalary",headerText:"CurrentSalary",width:"130",clipMode:"EllipsisWithTooltip",allowSearch:!1,allowFilter:!1,allowSort:!1}],isConditionalRowSelection:!0,sortSettings:{enabled:!0},filterSettings:{enabled:!0},virtualizationSettings:{scrollMode:y.Virtual},height:"100%",query:new Te().addParams("serverpagesize","50")}},be={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:T,PagerModule:R,GroupModule:A,ToolbarModule:E,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:L,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},dataSource:et,children:t.jsxs(Ve,{children:[t.jsx(z,{headerText:"Employee Image",width:"180",textAlign:Qe.Center,field:"EmployeeID"}),t.jsx(z,{headerText:"Employee Details",width:"300",textAlign:Qe.Left,field:"FirstName"})]}),className:"row-template",toolbar:["Search"],selectionSettings:{mode:"Single"},searchSettings:{enabled:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0},height:"100%",rowTemplate:r=>{const v=`https://npmci-react.syncfusion.com/development-react-ui/images/grid/${r.EmployeeID}.png`;return t.jsxs("tr",{className:"templateRow",children:[t.jsx("td",{className:"photo",children:t.jsx("img",{src:v,alt:r.EmployeeID.toString()})}),t.jsx("td",{className:"details",children:t.jsxs("table",{className:"CardTable",cellPadding:3,cellSpacing:2,children:[t.jsxs("colgroup",{children:[t.jsx("col",{style:{width:"30%"}}),t.jsx("col",{style:{width:"10%"}})]}),t.jsxs("tbody",{children:[t.jsxs("tr",{children:[t.jsx("td",{className:"CardHeader",children:"First Name"}),t.jsx("td",{children:":"}),t.jsx("td",{children:r.FirstName})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"CardHeader",children:"Last Name"}),t.jsx("td",{children:":"}),t.jsx("td",{children:r.LastName})]}),t.jsxs("tr",{children:[t.jsx("td",{className:"CardHeader",children:"Title"}),t.jsx("td",{children:":"}),t.jsx("td",{children:r.Title})]})]})]})})]})}}},lt=[{field:"id"},{field:"username",width:150},{field:"age",width:80,type:"number"},{field:"bio",width:400}],xe={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:T,PagerModule:R,GroupModule:A,ToolbarModule:E,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:L,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},localDataCount:1e5,isTextWrapData:!0,columns:lt,height:400,textWrapSettings:{enabled:!0,wrapMode:$n.Both}}},Me={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:T,PagerModule:R,GroupModule:A,ToolbarModule:E,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:L,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},localDataCount:1e3,columns:(()=>{let r=[...W.slice(0,11)];return r.unshift({type:Y.SingleGroup,format:"C2"}),r=r.map(v=>({...v,...v.field==="sales"?{groupCaptionAggregateType:[ge.Min,ge.Max],valueAccessor:c=>{var s,g,h;return((s=c.column)!=null&&s.groupCaptionAggregateType&&((g=c.data)!=null&&g.key)?"Min & Max: ":"")+((h=c.data)==null?void 0:h[c.field])},template:c=>{var s,g,h,k,B,j;return(s=c.column)!=null&&s.groupCaptionAggregateType&&((g=c.data)!=null&&g.key)?`Min & Max: ${(k=c.data)==null?void 0:k[(h=c.column)==null?void 0:h.field]}`:((j=c.data)==null?void 0:j[(B=c.column)==null?void 0:B.field])??""},width:280,format:"C2"}:{}})),r})(),children:(()=>{let r=[...W.slice(0,11)];r.unshift({type:Y.SingleGroup,format:"C2"}),r=r.map(c=>({...c,...c.field==="sales"?{groupCaptionAggregateType:[ge.Min,ge.Max],valueAccessor:s=>{var g,h,k;return((g=s.column)!=null&&g.groupCaptionAggregateType&&((h=s.data)!=null&&h.key)?"Min & Max: ":"")+((k=s.data)==null?void 0:k[s.field])},template:s=>{var g,h,k,B,j,he;return(g=s.column)!=null&&g.groupCaptionAggregateType&&((h=s.data)!=null&&h.key)?`Min & Max: ${(B=s.data)==null?void 0:B[(k=s.column)==null?void 0:k.field]}`:((he=s.data)==null?void 0:he[(j=s.column)==null?void 0:j.field])??""},width:280,format:"C2"}:{}}));const v=r.map(c=>t.jsx(z,{...c}));return t.jsx(Ve,{children:v})})(),gridLines:Kn.Default,rowNumberSettings:{enabled:!0},onDataLoadStart:r=>{console.log("onDataLoadStart: ",r)},onGroupStart:()=>{console.log("onGroupStart Started")},onGroup:r=>{console.log("Group action: ",r)},onSortStart:()=>{console.log("Sort Started")},onSort:r=>{console.log("Sort action: ",r)},clipMode:Bn.EllipsisWithTooltip,groupSettings:{enabled:!0,columns:["category","product","region"],defaultExpanded:!0,showDropArea:!0,type:"SingleColumn",captionFormat:"verbose",groupSummaryPosition:Hn.Top},sortSettings:{enabled:!0,columns:[{field:"product",direction:"Descending"}]},isCustomBinding:!0,pageSettings:{enabled:!0,pageSize:2},virtualizationSettings:{scrollMode:y.Virtual},defaultOpenGroupExpandKeys:["Camera","Camera-South America","Medical Scanner","Medical Scanner-East Asia","Gaming Chair","Gaming Chair-South Asia","Laptop","Laptop-North America","Tires","Tires-East Asia","Scanner","Scanner-Western Europe","Air Conditioner","Air Conditioner-North Africa","E-learning Tablet","E-learning Tablet-Nordics","Game Controller","Game Controller-South Asia","Whiteboard","Whiteboard-Middle East","Mouse","Mouse-South America","Microwave","Microwave-Sub-Saharan Africa","Accessories","Accessories-Camera","Accessories-Camera-South America","Agriculture","Agriculture-Medical Scanner","Agriculture-Medical Scanner-East Asia","Construction","Construction-Gaming Chair","Construction-Gaming Chair-South Asia","Electronics","Electronics-Laptop","Electronics-Laptop-North America","Energy","Energy-Tires","Energy-Tires-East Asia","Furniture","Furniture-Scanner","Furniture-Scanner-Western Europe","Healthcare","Healthcare-Air Conditioner","Healthcare-Air Conditioner-North Africa","Insurance","Insurance-E-learning Tablet","Insurance-E-learning Tablet-Nordics","Logistics","Logistics-Game Controller","Logistics-Game Controller-South Asia","Networking","Networking-Whiteboard","Networking-Whiteboard-Middle East","Peripherals","Peripherals-Mouse","Peripherals-Mouse-South America","Retail","Retail-Microwave","Retail-Microwave-Sub-Saharan Africa"],editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Add","Edit","Delete","Update","Cancel","Search"],searchSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0,type:"Excel"},height:"100%"}},De={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:T,PagerModule:R,GroupModule:A,ToolbarModule:E,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:L,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},dataSource:new Ge({url:"https://ej2services.syncfusion.com/react/development/odata/GridInfiniteODataV4",adaptor:new _n}),columns:[{type:Y.Checkbox,width:50,allowFilter:!1},{field:"RecordId",headerText:"Record ID",isPrimaryKey:!0},{field:"AssetGroup",headerText:"Asset Group"},{field:"HourlyCost",headerText:"Hourly Cost"},{field:"EstimatedHours",headerText:"Estimated Hours"},{field:"MaintenanceCost",headerText:"Maintenance Cost"},{field:"RequestedDate",headerText:"Requested Date"},{field:"PlannedDate",headerText:"Planned Date"},{field:"CompletionDate",headerText:"Completion Date"},{field:"Status",headerText:"Status"},{field:"RequestOrigin.Division",headerText:"Request Division"}],isConditionalRowSelection:!0,virtualizationSettings:{scrollMode:y.Infinite,enableCache:!0},sortSettings:{enabled:!0},filterSettings:{enabled:!0,type:"Excel",mode:"OnEnter"},onFilterStart:()=>{console.log("Filter Started")},onFilter:r=>{console.log("Filter action: ",r)},pageSettings:{enabled:!0},searchSettings:{enabled:!0},toolbar:["Search"],height:"100%"}},Ee={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:T,PagerModule:R,GroupModule:A,ToolbarModule:E,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:L,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},serverPageSize:50,localDataCount:5e3,columns:W.slice(1,11),isCustomBinding:!0,virtualizationSettings:{scrollMode:y.Infinite},sortSettings:{enabled:!0},resizeSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},searchSettings:{enabled:!0},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Search","Add","Edit","Delete","Update","Cancel"],pageSettings:{enabled:!1,pageSize:50},height:"100%"}},Ae={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:T,PagerModule:R,GroupModule:A,ToolbarModule:E,ContextMenuModule:D,ColumnChooserModule:M,SearchModule:L,CommandColumnModule:N,AggregateModule:V,AutoFillModule:O,ResizeModule:P,AutoFitModule:I},serverPageSize:50,localDataCount:5e3,columns:W.slice(0,11),isCustomBinding:!0,virtualizationSettings:{scrollMode:y.Virtual},isConditionalRowSelection:!0,sortSettings:{enabled:!0},filterSettings:{enabled:!0,enableFilterBarOperator:!0},searchSettings:{enabled:!0},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},toolbar:["Search","Add","Edit","Delete","Update","Cancel"],height:"100%"}},Re={args:{modules:{ClipboardModule:F,FilterModule:G,EditModule:T,PagerModule:R,GroupModule:A,ToolbarModule:E,ContextMenuModule:D,ColumnChooserModule:M},dataSource:[{OrderID:1,CustomerID:"A",Freight:10,ShipCountry:"USA"},{OrderID:2,CustomerID:"B",Freight:20,ShipCountry:"UK"}],height:400,width:800,selectionSettings:{enabled:!0,type:"Cell",mode:"Multiple"},editSettings:{allowEdit:!0,allowAdd:!0,allowDelete:!0,mode:"Normal"},children:t.jsxs(Ve,{children:[t.jsx(z,{field:"OrderID",headerText:"Order ID",width:"120",isPrimaryKey:!0,type:"number"}),t.jsx(z,{field:"CustomerID",headerText:"Customer ID",width:"150"}),t.jsx(z,{field:"Freight",headerText:"Freight",width:"100",format:"C2",type:"number"}),t.jsx(z,{field:"ShipCountry",headerText:"Ship Country",width:"150"}),t.jsx(z,{field:"Complex.ShipCity",headerText:"Ship City",width:"150"}),t.jsx(z,{field:"OrderDate",headerText:"Order Date",width:"140",type:"datetime",format:"yMd"}),t.jsx(z,{field:"isActive",width:"100",type:"boolean"})]})}};var $e,_e,Je;Se.parameters={...Se.parameters,docs:{...($e=Se.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(Je=(_e=Se.parameters)==null?void 0:_e.docs)==null?void 0:Je.source}}};var Xe,Ye,Ze;we.parameters={...we.parameters,docs:{...(Xe=we.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(Sn=(Cn=De.parameters)==null?void 0:Cn.docs)==null?void 0:Sn.source}}};var wn,yn,vn;Ee.parameters={...Ee.parameters,docs:{...(wn=Ee.parameters)==null?void 0:wn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(vn=(yn=Ee.parameters)==null?void 0:yn.docs)==null?void 0:vn.source}}};var bn,xn,Mn;Ae.parameters={...Ae.parameters,docs:{...(bn=Ae.parameters)==null?void 0:bn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(Mn=(xn=Ae.parameters)==null?void 0:xn.docs)==null?void 0:Mn.source}}};var Dn,En,An;Re.parameters={...Re.parameters,docs:{...(Dn=Re.parameters)==null?void 0:Dn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(An=(En=Re.parameters)==null?void 0:En.docs)==null?void 0:An.source}}};const gt=["LocalData","OverComeBrowserLimit","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TextWrapSample","GroupingSample","ODataV4Sample","CustomBindingSample","conditionalRowSelection","TestGrid"];export{Ee as CustomBindingSample,Me as GroupingSample,Se as LocalData,De as ODataV4Sample,we as OverComeBrowserLimit,be as RowTemplate,Re as TestGrid,xe as TextWrapSample,ye as UrlAdaptorData,ve as WebApiAdaptorData,gt as __namedExportsOrder,Ae as conditionalRowSelection,mt as default};
